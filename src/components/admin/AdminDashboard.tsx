...
import { ArrowUpRight, ArrowDownRight, Clock, CarFront, CheckCircle2, AlertTriangle, Play, Settings } from 'lucide-react';
      ...
      <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
           ...
           <div className="bg-white border-t-4 border-orange-500 shadow-sm p-6">
              ...
              <div className="flex items-end justify-between">
                 <span className="text-3xl font-black text-gray-900">105</span>
           ...
           <div className="bg-white border-t-4 border-brand-maroon shadow-sm p-6">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-widest block mb-2">Revenue Today</span>
              <div className="flex items-end justify-between">
                 <span className="text-3xl font-black text-brand-maroon">₵ 45.2K</span>
              ...
              <div className="bg-red-50 border border-red-200 shadow-sm p-6 relative overflow-hidden">
                 <div className="relative z-10 flex flex-col h-full justify-between">
                    <div>
                       ...
                       <p className="text-2xl font-black text-red-700 mb-1">3 Pending</p>
                       <p className="text-sm text-red-800 font-medium mb-6">Bookings awaiting driver assignment.</p>
                    </div>
                    <button className="w-full bg-red-600 hover:bg-red-700 text-white font-black uppercase tracking-widest text-xs py-3 transition-colors shadow-sm">
                       Assign Now
                    </button>
                 </div>
              </div>
